...
export default async (req, res) => {
  ...
  try {
    ...
    await db.query(    
    `INSERT INTO HotelRoom (hotel_room_no, room_size, room_floor, room_price, mini_bar_prices, has_cleaned, hotel_id) VALUES 
    (${hotelRoomNo}, ${room_size},${floor}, ${price} ,${minibar_price},1,${hotel_id});`, (err,result,fields) => {
      if (err) {  
