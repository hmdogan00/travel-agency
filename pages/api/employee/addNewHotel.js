...
export default async (req, res) => {
  ...
  try {
    await db.query(`
    INSERT INTO Hotel (name, location, rating, phone_no, occupancy_rate, no_of_empty_room, no_of_total_room)
    VALUES ('${name}', '${location}', 0, ${phone_no}, '${occupancy_rate}', '${no_of_empty_room}', '${no_of_total_room}');`, (err, result, fields) => {
      if (err) {
